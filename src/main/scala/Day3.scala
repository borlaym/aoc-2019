...
object Day3 {
	...
	def getSegments(input: String): List[Segment] = {
		val commands = input.split(",")
		commands.foldLeft((List[Segment](), (0, 0)))((status, command) => {
			val list = status._1
